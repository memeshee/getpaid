...
import 'package:getpaid_client/src/protocol/billing/chase_report.dart'
    as _iv41z73z;
...
import 'package:getpaid_client/src/protocol/billing/invoice_item_input.dart'
    as _i1bate66;
import 'package:getpaid_client/src/protocol/billing/invoice_thread.dart'
    as _iwhkp546;
import 'package:getpaid_client/src/protocol/billing/payment.dart' as _iepr502h;
import 'package:getpaid_client/src/protocol/greetings/greeting.dart'
    as _ip3nd3vg;
...
class EndpointInvoice extends _isc.EndpointRef {
  ...
  _ida.Future<List<_idhwohgz.Customer>> listCustomers() =>
      caller.callServerEndpoint<List<_idhwohgz.Customer>>(
        'invoice',
        'listCustomers',
        {},
      );

  _ida.Future<_idhwohgz.Customer> createCustomer({
    required String name,
    required String email,
    String? company,
  }) => caller.callServerEndpoint<_idhwohgz.Customer>(
    'invoice',
    'createCustomer',
    {
      'name': name,
  ...
  _ida.Future<List<_idcg60kg.Invoice>> listInvoices() =>
      caller.callServerEndpoint<List<_idcg60kg.Invoice>>(
        'invoice',
        'listInvoices',
        {},
      );

  _ida.Future<_idcg60kg.Invoice> createInvoice({
    required int customerId,
    required int amountCents,
    required String currency,
    String? notes,
    required DateTime dueDate,
    List<_i1bate66.InvoiceItemInput>? items,
  }) => caller.callServerEndpoint<_idcg60kg.Invoice>(
    'invoice',
    'createInvoice',
    {
  ...
  _ida.Future<_idcg60kg.Invoice> sendInvoice(int invoiceId) =>
      caller.callServerEndpoint<_idcg60kg.Invoice>(
        'invoice',
        'sendInvoice',
        {'invoiceId': invoiceId},
  ...
  _ida.Future<_iwhkp546.InvoiceThread> getThread(int invoiceId) =>
      caller.callServerEndpoint<_iwhkp546.InvoiceThread>(
        'invoice',
        'getThread',
        {'invoiceId': invoiceId},
      );
  ...
  _ida.Future<_iepr502h.Payment> markPaid(
    int invoiceId, {
    required int amountCents,
    String? method,
  }) => caller.callServerEndpoint<_iepr502h.Payment>(
    'invoice',
    'markPaid',
    {
      'invoiceId': invoiceId,
  ...
  _ida.Future<_iv41z73z.ChaseReport> simulate(int daysAhead) =>
      caller.callServerEndpoint<_iv41z73z.ChaseReport>(
        'invoice',
        'simulate',
        {'daysAhead': daysAhead},
      );
...
class EndpointGreeting extends _isc.EndpointRef {
  ...
  _ida.Future<_ip3nd3vg.Greeting> hello(String name) =>
      caller.callServerEndpoint<_ip3nd3vg.Greeting>(
        'greeting',
        'hello',
        {'name': name},
      );
