...
import 'package:getpaid_server/src/generated/billing/chase_payload.dart'
    as _iwur04d6;
import 'package:getpaid_server/src/generated/billing/chase_report.dart'
    as _ivx0un0r;
...
import 'package:getpaid_server/src/generated/billing/invoice_item_input.dart'
    as _iwnarrtv;
import 'package:getpaid_server/src/generated/billing/invoice_thread.dart'
    as _iji5leb5;
import 'package:getpaid_server/src/generated/billing/payment.dart' as _iksioaa4;
import 'package:getpaid_server/src/generated/future_calls.dart' as _i09cgdbq;
import 'package:getpaid_server/src/generated/greetings/greeting.dart'
    as _ihc1fqay;
...
import 'package:getpaid_server/src/generated/endpoints.dart';
...
class _FutureCalls {
  late final chase = _ChaseFutureCall();
}
...
class _InvoiceEndpoint {
  ...
  _ida.Future<List<_i81258m6.Customer>> listCustomers(
    _ist.TestSessionBuilder sessionBuilder,
  ) async {
    return _ist.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
      ...
      try {
        ...
        var _localReturnValue =
            await (_localCallContext.method.call(
                ...
                as _ida.Future<List<_i81258m6.Customer>>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
  ...
  _ida.Future<_i81258m6.Customer> createCustomer(
    _ist.TestSessionBuilder sessionBuilder, {
      ...
      try {
        ...
        var _localReturnValue =
            await (_localCallContext.method.call(
                ...
                as _ida.Future<_i81258m6.Customer>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
  ...
  _ida.Future<List<_iy2zabab.Invoice>> listInvoices(
    _ist.TestSessionBuilder sessionBuilder,
  ) async {
    return _ist.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
      ...
      try {
        ...
        var _localReturnValue =
            await (_localCallContext.method.call(
                ...
                as _ida.Future<List<_iy2zabab.Invoice>>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
  ...
  _ida.Future<_iy2zabab.Invoice> createInvoice(
    _ist.TestSessionBuilder sessionBuilder, {
    ...
    List<_iwnarrtv.InvoiceItemInput>? items,
  }) async {
    return _ist.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _ist.InternalTestSessionBuilder).internalBuild(
      ...
      try {
        ...
        var _localReturnValue =
            await (_localCallContext.method.call(
                ...
                as _ida.Future<_iy2zabab.Invoice>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
  ...
  _ida.Future<_iy2zabab.Invoice> sendInvoice(
    _ist.TestSessionBuilder sessionBuilder,
    int invoiceId,
  ) async {
    return _ist.callAwaitableFunctionAndHandleExceptions(() async {
  ...
  _ida.Future<_iji5leb5.InvoiceThread> getThread(
    _ist.TestSessionBuilder sessionBuilder,
    int invoiceId,
  ) async {
    return _ist.callAwaitableFunctionAndHandleExceptions(() async {
      ...
      try {
        ...
        var _localReturnValue =
            await (_localCallContext.method.call(
                ...
                as _ida.Future<_iji5leb5.InvoiceThread>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
  ...
  _ida.Future<_iksioaa4.Payment> markPaid(
    _ist.TestSessionBuilder sessionBuilder,
    int invoiceId, {
    required int amountCents,
    String? method,
      ...
      try {
        ...
        var _localReturnValue =
            await (_localCallContext.method.call(
                ...
                as _ida.Future<_iksioaa4.Payment>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
  ...
  _ida.Future<_ivx0un0r.ChaseReport> simulate(
    _ist.TestSessionBuilder sessionBuilder,
    int daysAhead,
  ) async {
    return _ist.callAwaitableFunctionAndHandleExceptions(() async {
      ...
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          ...
          endpointPath: 'invoice',
          methodName: 'simulate',
          parameters: _ist.testObjectToJson({'daysAhead': daysAhead}),
          serializationManager: _serializationManager,
        );
        var _localReturnValue =
            await (_localCallContext.method.call(
                ...
                as _ida.Future<_ivx0un0r.ChaseReport>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
...
class _GreetingEndpoint {
  ...
  _ida.Future<_ihc1fqay.Greeting> hello(
    _ist.TestSessionBuilder sessionBuilder,
    String name,
  ) async {
    return _ist.callAwaitableFunctionAndHandleExceptions(() async {
      ...
      try {
        ...
        var _localReturnValue =
            await (_localCallContext.method.call(
                ...
                as _ida.Future<_ihc1fqay.Greeting>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
...
class _ChaseFutureCall {
  Future<void> checkChase(
    _ist.TestSessionBuilder sessionBuilder,
    ...
    var _localUniqueSession =
        (sessionBuilder as _ist.InternalTestSessionBuilder).internalBuild();
    try {
      await _i09cgdbq.ChaseCheckChaseFutureCall().invoke(
        _localUniqueSession,
        payload,
      );
    } finally {
