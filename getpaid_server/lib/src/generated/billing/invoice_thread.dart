...
abstract class InvoiceThread
  ...
  factory InvoiceThread.fromJson(Map<String, dynamic> jsonSerialization) {
    return InvoiceThread(
      invoice: _ikj3fuet.Protocol().deserialize<_i78desnl.Invoice>(
        jsonSerialization['invoice'],
      ),
      client: jsonSerialization['client'] == null
          ? null
          : _ikj3fuet.Protocol().deserialize<_i5j7u0j7.Customer>(
              jsonSerialization['client'],
            ),
      items: _ikj3fuet.Protocol().deserialize<List<_izlwvvwo.InvoiceItem>>(
        jsonSerialization['items'],
      ),
      reminders: _ikj3fuet.Protocol().deserialize<List<_i0keiged.Reminder>>(
        jsonSerialization['reminders'],
      ),
      payments: _ikj3fuet.Protocol().deserialize<List<_i5od23c2.Payment>>(
